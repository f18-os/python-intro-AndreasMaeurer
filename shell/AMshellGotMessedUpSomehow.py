...
while (True):
	...
	#export PS1="[\u@\h \W]$ "  #The usual bash prompt
	#PS1 = "[\u@\h \W]$ "
	PS1 = "$ "
	
	shellInput = input(PS1)						#The input() function allows user input.  (built into Python) according to: https://github.com/robustUTEP/os-shell the prompt should be: "$ "
